        ...
        par_processors = [
            ...
            (self.par_has_words,
             ["знать", "уметь", "владеть", "технология", "оценочный",
              ...
              "кибернетика","информатика","ректор","проректор", "деятельность",
              "разработка","определение","воспроизводство",
              "проектный","конструкторский","базироваться",
              "курс","дисциплина","модуль","составлять","программа",
              "подпись","одобрять","документ"]),
            (self.par_has_compounds, list(
                map(lambda x: x.split(" "), [
                    "рабочий программа дисциплина",
                    "образовательный программа дисциплина",
